...
<div class="super_container">
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					...
					<div class="section_subtitle">that makes us advisable</div>
				</div>
			</div>
			<div class="row about_row row-eq-height">
				<div class="col-lg-4">
					<div class="logo">
						<a href="#">Care<span>+</span></a>
					</div>
					<div class="about_text_highlight">e-Clinic Portal Group has over two decades of experience in the healthcare sector, and is known for providing quality healthcare and valuable experience to all domestic and international patients. </div>
					<div class="about_text">
						<p>e-Clinic Portal, a healthcare landmark, has been a household name to more than 50 million Indians. We currently have branches in Bhubaneswar (KIIT).</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="about_text_2">
						<p>As a result of Strong’s approach, each and every patient has an extensive number of specialists who can be seamlessly integrated into their health care team. A condition is never isolated. Patients always have a team of people and specialists taking care of them, all supported with the highest technology. </p>
					</div>
				</div>
				<div class="col-lg-4">
			...
			<div class="row">
				<div class="col">
					<div class="button about_button ml-auto mr-auto"><a href="#"><span>call now</span><span>+9801083309</span></a></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="cta">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/cta_1.jpg" data-speed="0.9"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="cta_container d-flex flex-xl-row flex-column align-items-xl-start align-items-center justify-content-xl-start justify-content-center">
						<div class="cta_content text-xl-left text-center">
							...
							<div class="cta_subtitle"><center>Your Care is our Concern.</center></div>
						</div>
		...
		<div class="container">
			...
			<div class="row doctors_row">
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						 <div class="doctor_image"><img src="images/Aayush Satwat.jpg" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Aayush Satwat</a></div>
							<div class="doctor_title">Cardiologist</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="doctor_image"><img src="images/Rohit Raj.jpg" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Rohit Raj</a></div>
							<div class="doctor_title">ENT Surgeon</div>
							<div class="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="doctor_image"><img src="images/Ananya Patro.jpg" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Ananya Patro</a></div>
							<div class="doctor_title">Physician</div>
							<div class="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="doctor_image"><img src="images/Ashutosh Raj.jpg" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Ashutosh Raj</a></div>
							<div class="doctor_title">Dermatologist</div>
							<div class="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						...
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Abhishek Menon</a></div>
							<div class="doctor_title">Orthopedic</div>
							<div class="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="doctor_image"><img src="images/Adyasha.png" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr.Adyasha Kiran</a></div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						...
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Lipsa Panda</a></div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="doctor_image"><img src="images/Rajat Kumar.jpg" alt=""></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">Dr. Rajat Kumar</a></div>
	...
	<footer class="footer">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/footer.jpg" data-speed="0.9"></div>
